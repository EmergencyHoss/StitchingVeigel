...
SUMMARY_DIR = os.path.join(last_path, 'summary_ssd')
writer = SummaryWriter(log_dir=SUMMARY_DIR)
# path to save the model files
MODEL_DIR = os.path.join(last_path, 'model_ssd')
...
if __name__=="__main__":
    ...
    parser.add_argument('--train_path', type=str, default='../../StabStitch-D/training/')
    parser.add_argument('--test_path', type=str, default='../../StabStitch-D/testing/')
